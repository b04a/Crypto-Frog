...
class DeveloperPreview {
    ...
    let state1 = StaticModel(title: "Market Cup", value: "$12.5B", percentChange: 25.34)
    
    let state2 = StaticModel(title: "Total Volue", value: "$1.23Tr")
    
    let state3 = StaticModel(title: "Portfolio Value", value: "$50.4k", percentChange: -12.34)
